...
class _PatientState extends State<Patient> {
  ...
  late String currentUser; // assuming you store current user ID or username
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ValueListenableBuilder<bool>(
                                  ...
                                  builder: (context, refreshed, child) {
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        var filteredPatienten =
                                          ...
                                          String name = patient['name']
                                              .toString()
                                              .toLowerCase();
                                          String searchTerm = _searchController
                                              .text
                                              .toLowerCase();
                                                                ...
                                                                TextButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    removeResponsible(
                                                                        patient
                                                                            .id);
                                                                    // Toggle refreshNotifier to trigger reload
                                                                    refreshNotifier
                                                                            .value =
                                                                        !refreshNotifier
                                                                            .value;
